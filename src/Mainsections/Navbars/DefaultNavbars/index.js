...
function DefaultNavbar({
  ...
  const dropdownMenu = (
    ...
    >
      {({ TransitionProps }) => (
        ...
        >
          <CBox borderRadius="lg">
            <Typography variant="h1" color="white">
              <Icon ref={setArrowRef} sx={{ mt: -3 }}>
                arrow_drop_up
              </Icon>
            </Typography>
            <CBox shadow="lg" borderRadius="lg" p={2} mt={2}>
              {renderRoutes}
            </CBox>
          </CBox>
        </Grow>
  ...
  const nestedDropdownMenu = (
    ...
    >
      {({ TransitionProps }) => (
        ...
        >
          <CBox ml={2.5} mt={-2.5} borderRadius="lg">
            <CBox shadow="lg" borderRadius="lg" py={1.5} px={1} mt={2}>
              {renderNestedRoutes}
            </CBox>
          </CBox>
        </Grow>
  ...
  return (
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      ...
      >
        <CBox display="flex" justifyContent="space-between" alignItems="center">
          <CBox
            component={Link}
            to="/"
            lineHeight={1}
